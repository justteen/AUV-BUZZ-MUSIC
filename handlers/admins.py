...
async def resume(_, message: Message):
    if (
        ...
        await message.reply_text("✯AUV-BUZZ MUSIC✯=❗ Nothing is paused!")
    else:
        callsmusic.pytgcalls.resume_stream(message.chat.id)
        await message.reply_text("✯AUV-BUZZ MUSIC✯=⏸ Resumed!")
...
async def skip(_, message: Message):
    global que
    if message.chat.id not in callsmusic.pytgcalls.active_calls:
        await message.reply_text("✯AUV-BUZZ MUSIC✯=❗ Nothing is playing to skip!")
    else:
...
async def admincache(client, message: Message):
    ...
    #await message.reply_text("✯AUV-BUZZ MUSIC✯=❇️ Admin cache refreshed!")
